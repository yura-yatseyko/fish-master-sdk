...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FishMasterSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'yura-yatseyko' => 'yurka4321@gmail.com' }
  s.source           = { :git => 'https://github.com/yura-yatseyko/FishMasterSDK.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'FishMasterSDK/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FishMasterSDK' => ['FishMasterSDK/Assets/*.png']
  # }
